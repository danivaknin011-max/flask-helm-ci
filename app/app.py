...
BANK_BALANCE_GAUGE = Gauge('bank_total_balance_amount', 'Current balance of account 1')
...
def init_db():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS accounts (id INT PRIMARY KEY, balance DECIMAL(10,2))")

            cursor.execute("SELECT COUNT(*) as count FROM accounts")

            if cursor.fetchone()['count'] == 0:

                cursor.execute("INSERT INTO accounts (id, balance) VALUES (1, 0.00)")
...
def deposit():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            conn.commit() # שומרים את השינוי ב-DB

           

            # --- הוספנו כאן: משיכת היתרה החדשה ועדכון המטריקה מיד ---
